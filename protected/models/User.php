...
/**
 * This is the model class for table "gz_user".
 *
 * The followings are the available columns in table 'gz_user':
 * @property integer $id
 * @property string $username
 * @property string $password
 * @property integer $approvement
...
class User extends CActiveRecord
{
	...
	public function search()
	{
		...
		$criteria->compare('approvement',$this->approvement);
