...
class DebtsController extends Controller {
    ...
    public function actionUpdate($id) {
        ...
        if (isset($_POST['Debts'])) {
            if($model->all){
                var_dump($_POST['Debts']);
                $all = json_decode($model->all);
                var_dump($all);
                exit;
            }
            $model->attributes = $_POST['Debts'];
     ...
     * @param Debts $model the model to be validated
     */
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'debts-form') {
