...
<div class="span1">
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'phone3',array('size'=>30,'maxlength'=>30,'readOnly'=>'readOnly')); ?>
...
<div class="span1">
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model,'objection_reason',array('手机被盗'=>"手机被盗",'欠费金额没这么多'=>'欠费金额没这么多')); ?>
	...
	<div class="row">
		<?php echo $form->labelEx($model,'otherObjection'); ?>
		<?php echo $form->textField($model,'otherObjection',array('size'=>30,'maxlength'=>255,'placeholder'=>"其他异议理由")); ?>
		<?php echo $form->error($model,'otherObjection'); ?>
	</div>
